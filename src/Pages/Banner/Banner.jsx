        ...
        <div>
            <AwesomeSlider className='h-[830px] md:h-[660px] md:pt-10 bg-primary_bg_color'>
                ...
                <div className='bg-white w-full h-full'>
                    <div className='grid md:grid-cols-2 md:gap-8 bg-primary_bg_color p-5'>
                        <div className='col-span-1 flex flex-col justify-center mb-8 p-8 md:mb-0'>
                            ...
                            <Link to="/allFoods">
                                <button className='h-10 md:mt-20 bg-primary_btn_color text-white w-52'>See All Foods</button>
                            </Link>
                        </div>
                ...
                <div className='bg-white w-full h-full'>
                    <div className='grid md:grid-cols-2 md:gap-8 bg-primary_bg_color p-5'>
                        <div className='col-span-1 flex flex-col justify-center mb-8 p-8 md:mb-0'>
                            ...
                            <Link to="/allFoods">
                                <button className='h-10 md:mt-16 bg-primary_btn_color text-white w-52'>See All Foods</button>
                            </Link>
                        </div>
                        <div className='col-span-1'>
                ...
                <div className='bg-white w-full h-full'>
                    <div className='grid md:grid-cols-2 md:gap-8 bg-primary_bg_color p-5'>
                        <div className='col-span-1 flex flex-col justify-center mb-8 p-8 md:mb-0'>
                            <h1 className='text-5xl font-medium'>T-bone and porterhouse are steaks of beef cut from the short loin.</h1>
