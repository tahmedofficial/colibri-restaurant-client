...
const UpdatePage = () => {
    ...
    const { _id, foodName, price, image, madeBy, foodCategory, description, foodOrigin } = updateDatd;
    ...
    const handleUpdate = (event) => {
        ...
        const foodData = { image, foodName, price, madeBy, foodCategory, description, foodOrigin };
